...
import org.pouyadr.finalsoft.OnlineUsers;
...
import org.pouyadr.ui.Components.Switch;
...
public class DialogsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        final ActionBarMenuItem ghostmenu = menu.addItem(4,(Setting.getGhostMode()?R.drawable.ic_ghost:R.drawable.ic_ghost_disable));
        ...
        if (onlySelect) {
            Log.i("finalsoft","onlySelect true");
        ...
        ghostmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Setting.getGhostMode()) {
                    ghostmenu.setIcon(R.drawable.ic_ghost_disable);
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    if (onlySelect) {
                        Log.i("finalsoft","onlySelect true finishFragment()");
                       finishFragment();
        ...
        final TabLayout tabHost=new TabLayout(frameLayout.getContext());
        tabHost.setBackgroundColor(ThemeChanger.getcurrent().getTabLayoutColor());
        tabHost.setSelectedTabIndicatorColor(Color.parseColor("#ffffff"));
        ThemeChanger.settabhost(tabHost);
        tabHost.setSelectedTabIndicatorHeight(10);
        tabHost.setTabTextColors(Color.argb(100, 255, 255, 255), Color.WHITE);
        TabSetting.GetTabs(tabHost);
        tabHost.getTabAt(5).select();
        tabHost.setTabGravity(Gravity.BOTTOM);
        ...
        tabHost.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                //TODO:finalsoft tabsHost
                tab.setIcon(TabSetting.getSelectedICon(tab.getPosition()));
                int selectedtabgroup = tab.getPosition();
                DialogsAdapter.dialogscategory = selectedtabgroup;
                //dialogsAdapter.getDialogsArray();
                //TODO: finalsoft تغییر عنوان صفحه

                //region set title
                try {
                    IUpdateActionBar iUpdateActionBar = (IUpdateActionBar)context;
                    String title = "";
                    switch (selectedtabgroup) {
                        case 0:
                            title = "رباط ها";
                            break;
                        case 1:
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            title = "مخاطبین" + " (" + OnlineUsers.GetCount() + ")";
                            break;
                        case 4:
                            title = "برگزیده ها";
                            break;
                    ...
                    iUpdateActionBar.setActionBarTitle(title);
                }catch (Exception e){
                    Log.e("finalsoft"," dialogActivity tabHost.setOnTabSelectedListener error:"+e.getMessage());
                }
                //endregion
        ...
        frameLayout.addView(tabHost, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT));
//endregion
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (onlySelect) {
                    Log.i("finalsoft","onlySelect true didSelectResult()");
                ...
                if (dialog instanceof TLRPC.TL_dialogChannel) {
                    ...
                    builder.setItems(new CharSequence[]{
                        ...
                        public void onClick(DialogInterface dialog, final int which) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                            builder.setTitle(LocaleController.getString("AppName", R.string.AppName));
//                            Log.i("salam","witch:"+which);
                            if(which==0){
//                                Log.e("addToFAver", "clicked");
        ...
        floatingButton.setBackgroundResource(ThemeChanger.getcurrent().getFloatingbuttondrawble());
        ...
        if (searchString == null) {
            Log.i("finalsift","searchString dialogsType:"+dialogsType);
            ...
            listView.setAdapter(dialogsAdapter);
            dialogsAdapter.dialogscategory=tabHost.getSelectedTabPosition();
        }
        int type = 0;
        if (searchString != null) {
            type = 2;
        ...
        dialogsSearchAdapter.setDelegate(new DialogsSearchAdapter.DialogsSearchAdapterDelegate() {
            ...
            public void searchStateChanged(boolean search) {
                Log.i("finalsift","searchStateChanged dialogsType:"+dialogsType);
