...
import org.pouyadr.messenger.query.SharedMediaQuery;
...
import org.pouyadr.ui.Cells.AboutLinkCell;
import org.pouyadr.ui.Cells.DividerCell;
import org.pouyadr.ui.Cells.EmptyCell;
import org.pouyadr.ui.Cells.LoadingCell;
import org.pouyadr.ui.Cells.ShadowSectionCell;
import org.pouyadr.ui.Cells.TextCell;
import org.pouyadr.ui.Cells.TextDetailCell;
...
import org.pouyadr.ui.Components.IdenticonDrawable;
...
public class ProfileActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
        ...
        topView.setBackgroundColor(ThemeChanger.getcurrent().getActionbarcolor());
      //  topView.setBackgroundColor(AvatarDrawable.getProfileBackColorForId(user_id != 0 || ChatObject.isChannel(chat_id) && !currentChat.megagroup ? 5 : chat_id));
        ...
        for (int a = 0; a < 2; a++) {
            ...
            nameTextView[a].setTypeface(AndroidUtilities.getTypeface(org.pouyadr.finalsoft.Fonts.CurrentFont()));
    ...
    public void setAnimationProgress(float progress) {
        ...
        int r = Color.red(ThemeChanger.getcurrent().getActionbarcolor());
        int g = Color.green(ThemeChanger.getcurrent().getActionbarcolor());
        int b = Color.blue(ThemeChanger.getcurrent().getActionbarcolor());
